    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_submit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Log.e(TAG,"Error having no photo")
                Toast.makeText(this, "Error having no photo", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    fun submitPost(description: String, user:ParseUser , file: File) {
        ...
        post.saveInBackground{
            ...
            if (exception != null){
                ...
                findViewById<ImageView>(R.id.iv_image).setImageResource(R.drawable.image_placeholder)
                photoFile = null
            }
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                val ivPreview = findViewById<ImageView>(R.id.iv_image)
